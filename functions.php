...
function themeslug_assets() {
	$asset = include get_parent_theme_file_path( 'build/css/screen.asset.php' );

	wp_enqueue_style(
		'themeslug-style',
		get_parent_theme_file_uri( 'build/css/screen.css' ),
		$asset['dependencies'],
		$asset['version']
	);
}
...
function themeslug_editor_assets() {
	$script_asset = include get_parent_theme_file_path( 'build/js/editor.asset.php'  );
	$style_asset  = include get_parent_theme_file_path( 'build/css/editor.asset.php' );
